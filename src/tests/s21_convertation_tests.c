...
START_TEST(float_to_dec__19) {
  ...
  ck_assert_int_eq((int)res, 0);
  ck_assert_int_eq((int)res_bits.bits[0], 42);
  ck_assert_int_eq((int)res_bits.bits[1], 0);
  ck_assert_int_eq((int)res_bits.bits[2], 0);
  ck_assert_int_eq((int)res_bits.bits[3], 0);
}
...
Suite *test_convertation() {
  ...
  TCase *o = tcase_create("s21_convertation");
  suite_add_tcase(s, o);

  tcase_add_test(o, int_to_dec_1);
  tcase_add_test(o, int_to_dec_2);
  tcase_add_test(o, int_to_dec_3);
  tcase_add_test(o, int_to_dec_4);
  tcase_add_test(o, int_to_dec_5);
  tcase_add_test(o, int_to_dec_6);
  tcase_add_test(o, int_to_dec_7);
  tcase_add_test(o, int_to_dec_8);
  tcase_add_test(o, int_to_dec_9);
  tcase_add_test(o, int_to_dec_10);
  tcase_add_test(o, int_to_dec_11);
  tcase_add_test(o, int_to_dec_12);
  tcase_add_test(o, int_to_dec_13);
  tcase_add_test(o, int_to_dec_14);
  tcase_add_test(o, int_to_dec_15);
  tcase_add_test(o, int_to_dec_16);
  tcase_add_test(o, int_to_dec_17);
  tcase_add_test(o, int_to_dec_18);
  tcase_add_test(o, int_to_dec_19);
  tcase_add_test(o, int_to_dec_20);

  tcase_add_test(o, dec_to_int_1);
  tcase_add_test(o, dec_to_int_2);
  tcase_add_test(o, dec_to_int_3);
  tcase_add_test(o, dec_to_int_4);
  tcase_add_test(o, dec_to_int_5);
  tcase_add_test(o, dec_to_int_6);
  tcase_add_test(o, dec_to_int_7);
  tcase_add_test(o, dec_to_int_8);
  tcase_add_test(o, dec_to_int_9);
  tcase_add_test(o, dec_to_int_10);
  tcase_add_test(o, dec_to_int_11);
  tcase_add_test(o, dec_to_int_12);
  tcase_add_test(o, dec_to_int_13);
  tcase_add_test(o, dec_to_int_14);
  tcase_add_test(o, dec_to_int_15);
  tcase_add_test(o, dec_to_int_16);
  tcase_add_test(o, dec_to_int_17);
  tcase_add_test(o, dec_to_int_18);
  tcase_add_test(o, dec_to_int_19);
  tcase_add_test(o, dec_to_int_20);
  tcase_add_test(o, dec_to_int_21);
  tcase_add_test(o, dec_to_int_22);
  tcase_add_test(o, dec_to_int_23);
  tcase_add_test(o, dec_to_int_24);
  tcase_add_test(o, dec_to_int_25);

  tcase_add_test(o, dec_to_float_1);
  tcase_add_test(o, dec_to_float_2);
  tcase_add_test(o, dec_to_float_3);
  tcase_add_test(o, dec_to_float_4);
  tcase_add_test(o, dec_to_float_5);
  tcase_add_test(o, dec_to_float_6);
  tcase_add_test(o, dec_to_float_7);
  tcase_add_test(o, dec_to_float_8);
  tcase_add_test(o, dec_to_float_9);
  tcase_add_test(o, dec_to_float_10);
  tcase_add_test(o, dec_to_float_11);
  tcase_add_test(o, dec_to_float_12);
  tcase_add_test(o, dec_to_float_13);
  tcase_add_test(o, dec_to_float_14);
  tcase_add_test(o, dec_to_float_15);
  tcase_add_test(o, dec_to_float_16);
  tcase_add_test(o, dec_to_float_17);
  tcase_add_test(o, dec_to_float_18);
  tcase_add_test(o, dec_to_float_19);
  tcase_add_test(o, dec_to_float_20);
  tcase_add_test(o, dec_to_float_21);
  tcase_add_test(o, dec_to_float_22);
  tcase_add_test(o, dec_to_float_23);
  tcase_add_test(o, dec_to_float_24);
  tcase_add_test(o, dec_to_float_25);
  tcase_add_test(o, dec_to_float_26);
  tcase_add_test(o, dec_to_float_27);
  tcase_add_test(o, dec_to_float_28);
